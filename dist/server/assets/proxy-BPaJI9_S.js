import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-DlAz7EEQ.js";
import { c as createLucideIcon, L as Link } from "./router-D9PAxtDW.js";
const __iconNode$4 = [
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "glass-panel shadow-lg shadow-black/20" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-3.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5 group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "h-7 w-7 text-primary transition-all duration-500 group-hover:rotate-45 group-hover:scale-110" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-full bg-primary/20 blur-lg opacity-0 group-hover:opacity-100 transition-opacity" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display text-xl font-bold tracking-tight text-foreground", children: [
              "Earth",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Pulse" })
            ] })
          ] }),
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "md:hidden glass-panel mx-4 mb-4 rounded-2xl px-6 py-5 space-y-1", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border/30 bg-surface/50 glass-panel py-16 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6 relative z-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-sm leading-relaxed mb-4", children: "Delivering critical earth science, climate data, and environmental awareness. Knowledge is the first step toward meaningful change." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground flex items-center gap-1.5", children: [
          "Founded by ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-medium", children: "Ruhaan Mukherjee" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "h-3 w-3 text-earth-coral inline" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground mb-4 uppercase tracking-wider", children: "Navigate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block text-sm text-muted-foreground hover:text-primary transition-colors", children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/topics", className: "block text-sm text-muted-foreground hover:text-primary transition-colors", children: "Topics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/resources", className: "block text-sm text-muted-foreground hover:text-primary transition-colors", children: "Resources" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/action", className: "block text-sm text-muted-foreground hover:text-primary transition-colors", children: "Take Action" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/about", className: "block text-sm text-muted-foreground hover:text-primary transition-colors", children: "About" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground mb-4 uppercase tracking-wider", children: "Connect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "mailto:ruhaanmukherjee@gmail.com",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-sm font-semibold text-foreground mb-3 uppercase tracking-wider", children: "Topics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: ["Climate", "Oceans", "Forests", "Energy", "Wildlife"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs rounded-full glass-panel px-3 py-1 text-muted-foreground", children: t }, t)) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-8 border-t border-border/20 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " EarthPulse. Built with purpose for our planet."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Data sourced from NASA, NOAA, IPCC, and IUCN" })
    ] })
  ] }) });
}
