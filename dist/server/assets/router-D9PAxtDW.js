...
const appCss = "/assets/styles-DUSFUCEH.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-foreground font-display", children: "404" }),
...
const Route$6 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Earth Pulse — Awareness for Our Planet" },
      { name: "description", content: "Earth Pulse is an editorial magazine focused on earth science, climate awareness, and environmental information." },
      { name: "author", content: "Earth Pulse" },
      { property: "og:title", content: "Earth Pulse — Awareness for Our Planet" },
      { property: "og:description", content: "Earth science, climate awareness, and environmental information." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap" }
    ]
  }),
...
const $$splitComponentImporter$5 = () => import("./resources-Bh8-Zgg2.js");
const Route$5 = createFileRoute("/resources")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Curated resources for understanding our planet: datasets, documentaries, courses, and more."
    }, {
      property: "og:title",
      content: "Resources — Earth Pulse"
    }, {
      property: "og:description",
      content: "Curated resources for understanding our planet."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./action-Bk9pXUE3.js");
const Route$4 = createFileRoute("/action")({
  head: () => ({
    meta: [{
      title: "Take Action — Earth Pulse"
    }, {
      name: "description",
      content: "Practical ways to help protect our planet. From daily habits to systemic change."
    }, {
      property: "og:title",
      content: "Take Action — Earth Pulse"
    }, {
      property: "og:description",
      content: "Practical ways to help protect our planet."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./about-CBGCrN5x.js");
const Route$3 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Our mission is to make earth science accessible, urgent, and actionable."
    }, {
      property: "og:title",
      content: "About — Earth Pulse"
    }, {
      property: "og:description",
      content: "Making earth science accessible, urgent, and actionable for everyone."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-CQSdBGXD.js");
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./topics.index-DWR-XP5u.js");
const Route$1 = createFileRoute("/topics/")({
  head: () => ({
    meta: [{
      title: "Topics — Earth Pulse"
    }, {
      name: "description",
      content: "Explore climate, oceans, forests, energy, wildlife, and geology topics."
    }, {
      property: "og:title",
      content: "Topics — Earth Pulse"
    }, {
      property: "og:description",
      content: "Deep dives into the environmental subjects that matter most."
    }]
  }),
...
const TreePine = createLucideIcon("tree-pine", __iconNode$2);
const __iconNode$1 = [
  [
    "path",
    {
...
const topicContent = {
  "climate-change": {
    ...
    keyFacts: ["CO₂ levels have risen from 280 ppm (pre-industrial) to over 426 ppm today", "2023 was the hottest year in 125,000 years of recorded climate data", "The Arctic is warming nearly 4x faster than the global average", "Sea levels have risen about 21-24 cm since 1880", "Extreme weather events have increased 5x over the past 50 years"],
    articles: [{
      title: "Arctic Ice Hits Record Low for Third Consecutive Year",
      excerpt: "New satellite data reveals the extent of polar ice loss is accelerating faster than models predicted. Scientists say the current trajectory could lead to ice-free Arctic summers by 2040.",
      date: "Apr 12, 2026",
      readTime: "6 min",
      source: "NASA Earth Observatory",
      sourceUrl: "https://earthobservatory.nasa.gov"
    }, {
      title: "IPCC Sixth Assessment: What the Latest Report Tells Us",
      excerpt: "The most comprehensive climate report ever published confirms that human influence has warmed the atmosphere, ocean, and land at an unprecedented rate.",
      date: "Apr 5, 2026",
      readTime: "8 min",
      source: "IPCC",
      sourceUrl: "https://www.ipcc.ch"
    }, {
      title: "The Carbon Budget: How Much Time Do We Really Have?",
      excerpt: "At current emission rates, the remaining carbon budget for limiting warming to 1.5°C could be exhausted within this decade.",
      date: "Mar 28, 2026",
      readTime: "5 min",
      source: "Global Carbon Project",
      sourceUrl: "https://www.globalcarbonproject.org"
    }, {
      title: "Methane's Outsized Role in Near-Term Warming",
      excerpt: "Methane is 80x more potent than CO₂ over a 20-year period. Reducing methane emissions is the fastest lever to slow warming.",
      date: "Mar 20, 2026",
      readTime: "4 min",
      source: "UNEP",
  ...
  "oceans": {
    ...
    keyFacts: ["Oceans have absorbed 90% of excess heat from greenhouse gases", "Ocean acidity has increased 30% since the industrial revolution", "8 million tonnes of plastic enter the ocean every year", "50-80% of all life on Earth is found under the ocean surface", "Coral reefs support 25% of marine biodiversity on less than 1% of the ocean floor"],
    articles: [{
      title: "Deep Ocean Currents Show Signs of Slowing",
      excerpt: "Thermohaline circulation changes could reshape global weather patterns within decades. The Atlantic Meridional Overturning Circulation (AMOC) has weakened by 15% since the mid-20th century.",
      date: "Apr 8, 2026",
      readTime: "7 min",
      source: "NOAA",
      sourceUrl: "https://www.noaa.gov"
    }, {
      title: "The Great Barrier Reef: Recovery or Requiem?",
      excerpt: "After back-to-back mass bleaching events, scientists debate whether the world's largest coral system can survive another decade of warming.",
      date: "Apr 2, 2026",
      readTime: "6 min",
      source: "ARC Centre of Excellence",
      sourceUrl: "https://www.coralcoe.org.au"
    }, {
      title: "Microplastics Found in Deepest Ocean Trenches",
      excerpt: "Researchers have discovered plastic fragments at depths exceeding 10,000 meters, revealing the true extent of ocean contamination.",
      date: "Mar 25, 2026",
      readTime: "5 min",
  ...
  "forests": {
    ...
    keyFacts: ["We lose approximately 10 million hectares of forest per year", "The Amazon rainforest produces 20% of the world's oxygen", "Tropical forests contain about 25% of all terrestrial carbon", "80% of terrestrial biodiversity lives in forests", "Indigenous-managed forests have 36% lower deforestation rates"],
    articles: [{
      title: "Amazon Rainforest: Tipping Points and What They Mean",
      excerpt: "Scientists warn that deforestation may push the Amazon past a critical threshold where the forest transitions to savanna, releasing billions of tonnes of stored carbon.",
      date: "Apr 10, 2026",
      readTime: "7 min",
      source: "Nature Climate Change",
      sourceUrl: "https://www.nature.com"
    }, {
      title: "Reforestation at Scale: What's Working and What Isn't",
      excerpt: "From China's Great Green Wall to community-led projects in Kenya, a look at which reforestation strategies are delivering real results.",
      date: "Apr 3, 2026",
      readTime: "6 min",
      source: "World Resources Institute",
      sourceUrl: "https://www.wri.org"
    }, {
      title: "Old-Growth Forests: Why Age Matters for Carbon",
      excerpt: "New research shows that ancient forests store carbon at rates far exceeding young plantations, challenging simple tree-planting narratives.",
      date: "Mar 22, 2026",
      readTime: "5 min",
  ...
  "clean-energy": {
    ...
    keyFacts: ["Solar energy costs have dropped 90% in the last decade", "Renewables generated 30% of global electricity in 2023", "Wind and solar are now cheaper than coal in 90% of the world", "The clean energy sector employs over 13 million people globally", "Battery storage capacity is growing at 40% per year"],
    articles: [{
      title: "Renewable Energy Surpasses Fossil Fuels in EU Grid",
      excerpt: "For the first time, renewables generated more electricity than coal and gas combined in the European Union, marking a historic milestone.",
      date: "Apr 6, 2026",
      readTime: "5 min",
      source: "Ember Climate",
      sourceUrl: "https://ember-climate.org"
    }, {
      title: "Green Hydrogen: The Missing Piece of the Puzzle?",
      excerpt: "Could hydrogen produced from renewable energy decarbonize heavy industry, aviation, and shipping? The technology is promising but faces cost challenges.",
      date: "Mar 30, 2026",
      readTime: "7 min",
      source: "IEA",
      sourceUrl: "https://www.iea.org"
    }, {
      title: "The Nuclear Question: Is Fission Part of the Solution?",
      excerpt: "As SMRs (Small Modular Reactors) promise safer, cheaper nuclear power, the debate over nuclear's role in the energy transition intensifies.",
      date: "Mar 18, 2026",
      readTime: "6 min",
      source: "World Nuclear Association",
      sourceUrl: "https://world-nuclear.org"
    }]
  },
  "wildlife": {
    name: "Wildlife",
    ...
    keyFacts: ["1 million species are currently at risk of extinction", "Wildlife populations have declined 69% on average since 1970", "Insects — critical for pollination — have declined by 45% globally", "Only 15% of the world's land area is formally protected", "The illegal wildlife trade is worth up to $23 billion annually"],
    articles: [{
      title: "The Insect Apocalypse: Why Pollinator Decline Threatens Food Security",
      excerpt: "Without insects, global food production would collapse. New studies reveal the alarming scale of pollinator decline across continents.",
      date: "Apr 4, 2026",
      readTime: "6 min",
      source: "IUCN",
      sourceUrl: "https://www.iucn.org"
    }, {
      title: "30×30: Can We Protect 30% of Earth by 2030?",
      excerpt: "The COP15 biodiversity framework set an ambitious target. Here's how nations are — and aren't — delivering.",
      date: "Mar 27, 2026",
      readTime: "7 min",
      source: "Convention on Biological Diversity",
      sourceUrl: "https://www.cbd.int"
    }, {
      title: "Rewilding Europe: From Theory to Practice",
      excerpt: "How reintroducing apex predators and restoring ecosystems is transforming landscapes from Portugal to Romania.",
      date: "Mar 15, 2026",
      readTime: "5 min",
      source: "Rewilding Europe",
      sourceUrl: "https://rewildingeurope.com"
    }]
  },
  "geology": {
    name: "Geology & Land",
    ...
    keyFacts: ["We lose 24 billion tonnes of fertile soil every year", "Soil stores more carbon than the atmosphere and all plant life combined", "Mining directly impacts over 50 million hectares of land globally", "Only 3% of Earth's water is freshwater, mostly locked in ice and groundwater", "Groundwater depletion threatens agriculture for 2 billion people"],
    articles: [{
      title: "The Hidden Crisis: Why Soil Loss Matters More Than You Think",
      excerpt: "Soil degradation threatens global food security, yet it receives a fraction of the attention given to other environmental issues.",
      date: "Apr 1, 2026",
      readTime: "5 min",
      source: "FAO",
      sourceUrl: "https://www.fao.org"
    }, {
      title: "Critical Minerals for the Green Transition: The Mining Dilemma",
      excerpt: "The clean energy revolution requires massive amounts of lithium, cobalt, and rare earth metals. But mining them creates its own environmental costs.",
      date: "Mar 24, 2026",
      readTime: "7 min",
      source: "USGS",
      sourceUrl: "https://www.usgs.gov"
    }, {
      title: "Groundwater: The Invisible Resource We're Draining Dry",
      excerpt: "Satellite data reveals that 21 of the world's 37 largest aquifers are past sustainability tipping points, with no plan for recovery.",
      date: "Mar 12, 2026",
      readTime: "6 min",
      source: "NASA GRACE",
...
const $$splitNotFoundComponentImporter = () => import("./topics._topicId-Bmo472XN.js");
const $$splitComponentImporter = () => import("./topics._topicId-DvGWTjmY.js");
const Route2 = createFileRoute("/topics/$topicId")({
  head: ({
    params
  }) => {
    ...
    return {
      meta: [{
        ...
        name: "description",
        content: topic?.tagline ?? "Explore this environmental topic."
      }, {
        property: "og:title",
        content: `${name} — Earth Pulse`
      }, {
        property: "og:description",
        content: topic?.tagline ?? "Explore this environmental topic."
      }]
...
const ActionRoute = Route$4.update({
  id: "/action",
  path: "/action",
  getParentRoute: () => Route$6
});
...
const TopicsIndexRoute = Route$1.update({
  id: "/topics/",
  path: "/topics/",
  getParentRoute: () => Route$6
});
const TopicsTopicIdRoute = Route2.update({
  id: "/topics/$topicId",
  path: "/topics/$topicId",
  getParentRoute: () => Route$6
});
